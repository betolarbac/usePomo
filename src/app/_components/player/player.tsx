        ...
        <div className="max-w-80 flex-1 p-6 border border-zinc-800 rounded-md h-full text-white flex flex-col justify-between z-20 relative">
          <header className="flex flex-col gap-5">
            ...
            <div className="justify-items-center text-center">
              ...
              <strong className="text-base line-clamp-2">
                {currentRadio.title}
              </strong>
            </div>
          </header>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              <strong className="text-base line-clamp-1">
                {currentRadio.title}
              </strong>
              <Link
              ...
              <div className="flex justify-between">
                <span className="bg-red-400/10 px-1 text-sm rounded-sm border border-red-500 text-red-500">
                  Live
                </span>
              </div>
        ...
        <div className="flex items-center p-2 gap-3">
          <div>
            <Image
              ...
              width={270}
              height={140}
              className="rounded h-14 w-14 object-cover shadow-md"
            />
          </div>

          <div className="flex-1 min-w-0">
            <h3 className="font-medium truncate text-zinc-400">{currentRadio.title}</h3>
            <p className="text-sm text-muted-foreground truncate text-zinc-500">
              {currentRadio.artist}
            </p>
          </div>
