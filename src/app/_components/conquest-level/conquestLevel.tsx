    ...
    <div className="mb-2">
      <Dialog>
        <DialogTrigger asChild>
          <div className="flex items-center gap-2 bg-zinc-800 hover:bg-zinc-800/80 border-none p-2 px-3 rounded-sm cursor-pointer">
        ...
        <DialogContent className="bg-zinc-900 border border-zinc-800 text-zinc-300 max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
          <DialogHeader>
            ...
            <DialogDescription className="text-zinc-500">
              Você desbloqueou {unlockedCount} de {totalCount} conquistas.
              Continue completando sessões para desbloquear mais!
            </DialogDescription>
          </DialogHeader>
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h4
            className={`font-bold ${
              achievement.unlocked ? "text-primary" : "text-zinc-400"
            }`}
          >
            {achievement.name}
          </h4>
          ...
          <div className="mt-2">
            <div className="flex justify-between text-xs mb-1">
              <span
                className={
                  achievement.unlocked ? "text-primary" : "text-zinc-500"
                }
              >
            ...
            <Progress
              value={progress}
              className={`h-1.5 ${
                achievement.unlocked ? "bg-zinc-800" : "bg-zinc-900"
              }`}
            />
          </div>
        </div>
